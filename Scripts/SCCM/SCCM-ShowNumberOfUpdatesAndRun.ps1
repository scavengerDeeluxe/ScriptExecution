...
New-EventLog -LogName Application -Source SyncStateScriptRunner -ErrorAction SilentlyContinue
Write-EventLog -LogName Application -Source SyncStateScriptRunner -EventId 555 -EntryType Information -Message "Sync State ran successfully"
